...
//                         continue;
//                     }
//                     if (abs(land[i][j] - land[nx][ny]) < minCost) {
//                         minCost = abs(land[i][j] - land[nx][ny]);
//                         targetParents[0] = min(parentLand[i][j], parentLand[nx][ny]);
//                         targetParents[1] = max(parentLand[i][j], parentLand[nx][ny]);
//                     }
//                 }
//             }
//         }
...
//         for (int i = 0; i < N; i++) {
//             for (int j = 0; j < N; j++) {
//                 if (parentLand[i][j] == targetParents[1]) {
//                     parent[i * N + j] = targetParents[0];
//                     parentLand[i][j] = targetParents[0];
//                 }
//             }
//         }
//     }
